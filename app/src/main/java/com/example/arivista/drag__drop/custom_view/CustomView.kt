package com.example.arivista.drag__drop.custom_view
...
import com.example.arivista.drag__drop.R

class CustomView : RelativeLayout, View.OnDragListener {
    var options = ArrayList<Optionmodel>()
    var imageResource: Int? = null
    var optionscopy = ArrayList<Optionmodel>()
    var image: ImageView? = null
    internal lateinit var optionmodel: Optionmodel
